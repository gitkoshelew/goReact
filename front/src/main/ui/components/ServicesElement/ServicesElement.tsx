...
export const ServicesElement = ({
    ...
    return (
        <>
            {type === 'forkAndSpoon' &&
            <div onClick={() => onActiveClassHandler('elem1')}
            ...
            {
                type === 'swimmer' &&
                <div onClick={() => onActiveClassHandler('elem4')}
            ...
            {
                type === 'flower' &&
                <div onClick={() => onActiveClassHandler('elem3')}
            ...
            {
                type === 'case' &&
                <div onClick={() => onActiveClassHandler('elem2')}
