...
const {feedBackText, feedBack, feedBackUser, userFeedbackName, userFeedBackNationality, infoUserBlock, userPhoto,staplesBlock,userPhotoNameNationalityBlock} = s;
