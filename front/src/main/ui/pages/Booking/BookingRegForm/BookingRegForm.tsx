    ...
    <div className={bookingForm}>
      <div className={clientDescription}>
        ...
        <div className={formik.errors.firstName && formik.touched.firstName ? errorInputInfo : inputInfo}>
          First name:
          <input className={formik.errors.firstName && formik.touched.firstName ? errorInputInfoInput : inputInfoInput}
                 id={"firstName"} onBlur={formik.handleBlur} value={formik.values.firstName}
        ...
        <div className={formik.errors.lastName && formik.touched.lastName ? errorInputInfo : inputInfo}>
          Last name:
          <input className={formik.errors.lastName && formik.touched.lastName ? errorInputInfoInput : inputInfoInput}
                 id={"lastName"} onBlur={formik.handleBlur} value={formik.values.lastName}
                 onChange={formik.handleChange} type="text" />
        </div>
        {formik.errors.lastName && formik.touched.lastName ?
          <div className={errorMsg}>{formik.errors.lastName}</div> : null}


        <div className={formik.errors.email && formik.touched.email ? errorInputInfo : inputInfo}>
          Email:
          <input className={formik.errors.email && formik.touched.email ? errorInputInfoInput : inputInfoInput}
                 id={"email"} onBlur={formik.handleBlur} value={formik.values.email}
