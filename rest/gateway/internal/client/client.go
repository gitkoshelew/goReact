...
var (
	...
	// AuthDataDeleteService ...
	AuthDataDeleteService = New(fmt.Sprintf("http://%s:%s", os.Getenv("AUTH_SERVER_DOCKER_HOST"), os.Getenv("AUTH_SERVER_PORT")), "/authdata")
...
const (
	...
	// AuthDeleteQuerryParamsCtxKey ...
	AuthDeleteQuerryParamsCtxKey CtxKey = 10
)
