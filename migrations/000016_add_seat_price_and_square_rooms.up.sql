...
UPDATE ROOM SET square = 3 WHERE room_id = 31;
UPDATE ROOM SET square = 3 WHERE room_id = 32;
UPDATE ROOM SET square = 3 WHERE room_id = 33;
UPDATE ROOM SET square = 3 WHERE room_id = 34;
UPDATE ROOM SET square = 3 WHERE room_id = 35;
UPDATE ROOM SET square = 3 WHERE room_id = 36;
UPDATE ROOM SET square = 3 WHERE room_id = 37;
UPDATE ROOM SET square = 3 WHERE room_id = 38;
UPDATE ROOM SET square = 3 WHERE room_id = 39;
UPDATE ROOM SET square = 3 WHERE room_id = 40;
UPDATE ROOM SET square = 3 WHERE room_id = 41;
UPDATE ROOM SET square = 3 WHERE room_id = 42;
UPDATE ROOM SET square = 3 WHERE room_id = 43;
UPDATE ROOM SET square = 3 WHERE room_id = 44;
UPDATE ROOM SET square = 3 WHERE room_id = 45;
UPDATE ROOM SET square = 3 WHERE room_id = 46;
UPDATE ROOM SET square = 3 WHERE room_id = 47;
UPDATE ROOM SET square = 3 WHERE room_id = 48;
UPDATE ROOM SET square = 3 WHERE room_id = 49;
UPDATE ROOM SET square = 3 WHERE room_id = 50;

UPDATE seat SET price = 1 WHERE seat_id = 1;
UPDATE seat SET price = 12 WHERE seat_id = 2;
UPDATE seat SET price = 13 WHERE seat_id = 3;